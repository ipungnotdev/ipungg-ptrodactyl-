...
// Configuration
const apikey = 'ptlc_L0heyvBff59GZuJsyVqOXB6fx0h3ga1LsfglVxlJ2Ab';
const capikey = 'ptla_t3QlsZgHPvNG0fLq2A9RBlbK4gX9SZL4PSdEQoFtBAp',
';
const domain = 'https://ipungg-februari.tanks-order.my.id';
const nestid = '5';
const egg = '15';
const loc = '1';
const gmailadmin = 'admin@gmail.com'; // Admin email that won't be deleted
const telegramBotToken = '8321704877:AAHOXmUO2Y6FgyCISIGb9ToYEIVNbPGTS78';
const adminTelegramId = '7119819970';
...
app.post('/api/login', (req, res) => {
  ...
  if (username === 'pungg' && password === 'punggg') {
    res.json({ success: true, user: { username: 'pung', role: 'admin' } });
  } else {
